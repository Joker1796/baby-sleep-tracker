    ...
    return (
      <View style={styles.screen}>
        ...
        <Text style={styles.text}>
          Произошла ошибка. Ваши данные не пострадали — они хранятся на устройстве.
        </Text>
        <Pressable
          style={styles.btn}
...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: '#7c6ff0', borderRadius: 12, paddingVertical: 12, paddingHorizontal: 24, minHeight: 44, justifyContent: 'center' },
